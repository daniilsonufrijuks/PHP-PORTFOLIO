        ...
        <div class="content_container">
            ...
            <div class="about_page">
                ...
                <div class="about_content">
                    <p class="about_text"> Hi! I am Dan and I like coding! I am student in the RVT technical colege on 
                        the programming course. Thank you :) </p>
                </div>
                <div class="about_profile">
                    <ul class="left_profile">
                        <li><span class="profile_title">Date of Birth</span><span>May 20, 2005</span></li>
                        <li><span class="profile_title">Gender</span><span>Male</span></li>
                        <li><span class="profile_title">Age</span><span>18 Years Old</span></li>
                        <li><span class="profile_title">Maritial Status</span><span>Unmarried</span></li>
                        <li><span class="profile_title">Nationality</span><span>Latvian</span></li>
                        <!-- <li><span class="profile_title">Religion</span><span>Hindu</span></li> -->
                    </ul>

                    <ul class="right_profile">
                        <li><span class="profile_title">Profession</span><span>Open to suggestions</span></li>
                        <li><span class="profile_title">Address</span><span>Latvia, Riga</span></li>
                        <li><span class="profile_title">Contact</span><span>+371 22104399</span></li>
                        <li><span class="profile_title">Email</span><span>monolith@gmail.com</span></li>
